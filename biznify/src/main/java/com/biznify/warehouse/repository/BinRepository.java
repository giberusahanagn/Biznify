...
public interface BinRepository extends JpaRepository<Bin, Long> {
    ...
    // Find bins in a specific warehouse with available volume greater than a given amount
  //  List<Bin> findByRack_Aisle_Warehouse_WarehouseCodeAndAvailableVolumeGreaterThan(String warehouseCode, double minVolume);
    ...
    @Query("SELECT b FROM Bin b WHERE b.warehouseCode = :warehouseCode AND b.status IN ('EMPTY', 'PARTIALLY_FULL')")
